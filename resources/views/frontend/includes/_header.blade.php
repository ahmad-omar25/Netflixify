<nav class="navbar navbar-expand-lg navbar-dark fixed-top">
    ...
    <div class="container">
        ...
        <a class="navbar-brand" href="{{route('home')}}">Netflix<span
                class="text-primary font-weight-bold">ify</span></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form action="" class="col-12 col-md-6 p-0 mt-1">
                <div class="input-group">
                    <input type="search" class="form-control bg-transparent border-0"
                           ...
                           aria-label="Search for your favorite movies" aria-describedby="basic-addon2">
                    <div class="input-group-append">
                            <span class="input-group-text bg-transparent text-white border-0" id="basic-addon2"><i
            ...
            <ul class="navbar-nav ml-auto">
                @auth
                    <li class="nav-item">
                        <a href="" class="nav-link text-white mr-3" style="position: relative;">
                            <i class="fa fa-heart">
                                <span
