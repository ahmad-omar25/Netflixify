                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="d-flex justify-content-between">
                                    <h1 class="movie__name fw-300 text-capitalize">{{$latest_movie->name}}</h1>
                                ...
                                <div class="movie__cta my-4">
                                    <a href="{{route('movies.show', $latest_movie->slug)}}"
                                       class="btn btn-primary text-capitalize mr-0 mr-md-2"><span
