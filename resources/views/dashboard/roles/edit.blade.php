            ...
            <div class="col-md-12">
                ...
                <!-- Name -->
                    <div class="form-group">
                        ...
                        <input type="text" name="{{$input}}" value="{{old($input, $role->$input)}}"
                                    ...
                                    <td>
                                        ...
                                        <select name="permissions[]"
                                            ...
                                            @foreach($permission_maps as $permission_map)
                                                <option
                                                    value="{{$model. '_' .$permission_map}}" {{$role->hasPermission($model. '_' .$permission_map) ? 'selected' : ''}}>{{$permission_map}}</option>
                                            @endforeach
                                        </select>
                                        @error('permissions')
                                        <span class="invalid-feedback" role="alert">
